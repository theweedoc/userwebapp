        ...
        <Toolbar>
          ...
          <Box sx={{ display: { xs: "none", md: "flex" } }}>
            ...
            <IconButton size="large" edge="end" color="inherit">
              <Link to="videoupload" style={{textDecoration:false,color: 'inherit'}}> <AddCircleIcon />  </Link>
            ...
            <IconButton
              ...
              color="inherit"
            >
               <Link to="profile" style={{textDecoration:false,color: 'inherit'}}><AccountCircle />  </Link>
